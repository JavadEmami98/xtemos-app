    ...
    <div className=" w-full rounded-[8px] overflow-hidden border">
      <div className="relative">
        <img
          ...
          alt=""
          loading="lazy"
          className="lg:h-[192px] md:h-[192px] sm:h-[225px] object-cover w-full"
        />
        ...
        <Box
          ...
          className="absolute inline-block overflow-hidden text-center pt-[2px] font-bold bottom-[-20px] left-[50%]  px-[10px] bg-[#2e6bc6] rounded-[8px] text-[#fff] text-[12px]"
        >
