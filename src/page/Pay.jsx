     ...
     <Online/>
      ...
      <div className="lg:px-[136px] ">
         ...
         <div className="lg:flex md:flex grid grid-cols-3 items-center lg:gap-[24px] md:gap-[24px] gap-3 justify-center">
          <div className="flex items-center justify-center lg:px-[24px] md:px-[24px] px-[16px] lg:py-[13px] md:py-[13px] py-[8px] border-[2px] border-[#0040ff] bg-[#f0f5ff] rounded-[40px] lg:text-[14px] md:text-[14px] text-[12px] text-[#0040ff] font-semibold cursor-pointer"> 1 قسط </div>
          <div className="flex items-center justify-center lg:px-[24px] md:px-[24px] px-[16px] lg:py-[13px] md:py-[13px] py-[8px] border-[2px] border-[#6e798d]  rounded-[40px] lg:text-[14px] md:text-[14px] text-[12px] text-[#6e798d] font-semibold cursor-pointer"> 6 قسط </div>
      ...
      <div className="mt-[16px] lg:p-8 md:p-8 px-[8px] py-[12px] border-[4px] border-[#F2F5F8] rounded-[16px] bg-[#fff]">
        ...
        <div className="border-[2px] border-[#dee3e7] rounded-[12px] bg-[#f0f5ff]">
          ...
          <div className="flex lg:flex-row md:flex-row flex-col  justify-between px-[16px] pt-[24px] lg:pb-[24px] md:pb-[24px] pb-[8px] rounded-[11px] bg-[#fff]">
              ...
              <Button variant="contained" className="noShadow" sx={{height:"48px",p:"16px",color:"#fff",background:"#0040ff",cursor:"pointer",border:"1px solid #0040ff",fontSize:"bold",borderRadius:"12px",":hover":{background:"#0040ff"}}}>شرایط و مدارک مورد نیاز</Button>
            </div>
        </div>
      </div>
      </div>
